<section class="container-fluid content-education">
    ...
    <div class="container mt-5" style="border-top: 1px solid rgb(82, 78, 78)">
        <h1 class="mt-4">MIT Alumni News</h1>
        <div class="row mt-2">
            <div class="col-lg-6">
                <h5>
...
<section class="container mt-5  position-relative d-flex flex-column align-items-center justify-content-center ">
    <div class="row ">
        <div class="col-lg-6">
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/Alumni4.jpeg')}}" alt="" class="img-fluid"  style="min-height: 25vh;object-fit:cover">
                    </figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/Alumni5.jpeg')}}" alt="" class="img-fluid"  style="min-height: 25vh;object-fit:cover">
                    </figure>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/Alumni7.jpeg')}}" alt="" class="img-fluid"  style="min-height: 25vh;object-fit:cover">
                    </figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/Alumni8.jpeg')}}" alt="" class="img-fluid"  style="min-height: 25vh;object-fit:cover">
                    </figure>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <figure>
                <img src="{{asset('images/Alumni6.jpeg')}}" alt="" class="img-fluid"  style="min-height: 50vh;object-fit:cover">
            </figure>
        </div>
    </div>
    <div class="row ">
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/Alumni9.jpeg')}}" alt="" class="img-fluid"  style="min-height: 28.8vh;;object-fit:cover">
            </figure>

        </div>
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/Alumni10.jpeg')}}" alt="" class="img-fluid"  style="min-height: 28.8vh;;object-fit:cover">
            </figure>

        </div>
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/Alumni11.jpeg')}}" alt="" class="img-fluid"  style="min-height: 28.8vh;object-fit:cover">
            </figure>

        </div>
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/Alumni12.jpeg')}}" alt="" class="img-fluid"  style="min-height: 28.8vh;;object-fit:cover">
            </figure>
