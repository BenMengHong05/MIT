<section class="container-fluid content-education">
    ...
    <div class="container">
        ...
        <div class="container mt-5">
            <div class="row ">
                <h1>
                    At MIT, we revel in a culture of learning by doing. In 30
                    departments across five <span class="ul-hover-4">schools</span>  and one college, our
                    students combine analytical rigor with curiosity, playful
                    imagination, and an appetite for solving the hardest
                    problems in service to society. From science and
                    engineering to the arts, humanities, social sciences, and
                    <span class="ul-hover-4">interdisciplinary programs</span> , we offer excellence across the board.
                </h1>
            </div>
        </div>
        <div class="container mt-5">
            <div class="row mt-2">
                <div class="col-lg-6 education-text">
                    <h5>Our undergraduates work closely with faculty, tackle global
                        challenges, pursue fundamental questions, and translate ideas into
                        action. The core of the Institute’s teaching and research enterprise,
                        our graduate students and postdocs represent one of the most talented and diverse
                        cohorts in the world. To complement its academics, MIT offers a vibrant campus
                        environmentwith a wide range of clubs, teams, programs, and activities so that all students can
...
<section class="container education-imgae mt-5  position-relative d-flex justify-content-center">
    <div class="row">
        <div class="col-lg-6">
            <div class="row">
                <div class="col-lg-12">
                    <figure>
                        <img style="min-height: 50vh;object-fit:cover" src="{{asset('images/imgeducation1.jpg')}}" class="img-fluid" alt="">
                    </figure>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img style="min-height: 25vh;object-fit:cover" src="{{asset('images/imgeducation2.jpeg')}}" class="img-fluid" alt="">
                    </figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img style="min-height: 25vh;object-fit:cover" src="{{asset('images/imgeducation-3.jpg')}}" class="img-fluid" alt="">
                    </figure>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img style="min-height: 25vh;object-fit:cover" src="{{asset('images/imgeduaction.jpg')}}" class="img-fluid" alt="">
                    </figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img style="min-height: 25vh;object-fit:cover" src="{{asset('images/imgeducation.jpg')}}" class="img-fluid" alt="">
                    </figure>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <img style="min-height: 50vh;object-fit:cover" src="{{asset('images/imgeducation6.jpg')}}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>
