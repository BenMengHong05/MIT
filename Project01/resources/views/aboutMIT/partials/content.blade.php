            ...
            <div class="col-lg-6  ">
                <div class="campuslife d-flex  justify-content-center gap-5 ">
                    <div class="col-lg-3 " style="width: 29vh;">
                        <img style="height: auto; object-fit:cover " src="{{ asset('images/aboutslide1-1.jpg') }}" class="figure-img img-fluid " alt="">
                    ...
                    <div class="col-lg-3 " style="width: 20vh">
                        <img style="height: auto; object-fit:cover " src="{{ asset('images/aboutslide2-1.jpg') }} " class="figure-img img-fluid "
                            alt="">
                    </div>
                </div>
            </div>
...
<section class="container education-imgae  d-flex flex-column align-items-center justify-content-center " style="width: 100%; min-height: 60vh">
    <div class="row ">
        <div class="col-md-6 col-lg-6" style="height: 100%" >
            <figure>
                <img src="{{asset('images/slider-footer-about-mit1.jpeg')}}" class="img-fluid" alt="" style="min-height: 51.5vh; object-fit:cover">
            </figure>
        </div>
        <div class="col-md-6 col-lg-6">
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/slider-footer-about-mit2.jpeg')}}"  class="img-fluid" style="min-height: 25vh; object-fit:cover" >
                    </figure>
                    <figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/slider-footer-about-mit3.jpeg')}}"  class="img-fluid" style="min-height: 25vh;  object-fit:cover" >
                    </figure>
                    <figure>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/slider-footer-about-mit4.jpeg')}}"  class="img-fluid" style="min-height: 25vh;  object-fit:cover" >
                    </figure>
                    <figure>
                </div>
                <div class="col-lg-6">
                    <figure>
                        <img src="{{asset('images/slider-footer-about-mit5.jpeg')}}"  class="img-fluid" style="min-height: 25vh;  object-fit:cover" >
                    </figure>
                    <figure>
                </div>
            </div>
    ...
    <div class="row ">
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/slider-footer-about-mit6.jpeg')}}"  class="img-fluid" style="min-height: 25vh; object-fit:cover" >
            </figure>
            <figure>
        </div>
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/slider-footer-about-mit7.jpeg')}}"  class="img-fluid" style="min-height: 25vh; object-fit:cover" >
            </figure>
            <figure>
        </div>
        <div class="col-lg-3">
            <figure>
                <img src="{{asset('images/slider-footer-about-mit8.jpeg')}}"  class="img-fluid" style="min-height: 25vh; object-fit:cover" >
            </figure>
            <figure>
        </div>
    </div>
